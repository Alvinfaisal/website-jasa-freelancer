                                    ...
                                    @forelse ($orders as $item)
                                        <tr class="text-gray-700 border-b">
                                            <td class="px-1 py-5 text-sm w-2/8">
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                        @if ($item->user_frelancer->detail_user->photo != null)
                                                            <img class="object-cover w-full h-full rounded-full"
                                                                src="{{ url(Storage::url($item->user_frelancer->detail_user->photo)) }}"
                                                    ...
                                                    <div>
                                                        <p class="font-medium text-black">
                                                            {{ $item->user_frelancer->name ?? '' }}
                                                        </p>
                                                        <p class="text-sm text-gray-400">
                                                            {{ $item->user_frelancer->detail_user->role ?? '' }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td
                                                ...
                                                @if ($item->order_status_id == '1') {{ 'text-green-500' }}
                                            ...
                                            <td class="px-1 py-5 text-sm">
                                                <a href="{{ route('member.request.show', $item->id) }}"
