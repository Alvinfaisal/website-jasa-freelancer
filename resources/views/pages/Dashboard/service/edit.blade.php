                            ...
                            <div class="">
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        {{-- label form Estimasi dan Jumlah revisi --}}
                                        <div class="col-span-6 -mb-6">
                                            <label for="Estimation dan revision"
                                                class="block mb-3 font-medium text-gray-700 text-md">Estimasi Service &
                                                Jumlah Revisi</label>
                                        </div>

                                        {{-- input form delivery_time --}}
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="delivery_time" name="delivery_time" autocomplete="delivery_time"
                                                ...
                                                <option value="4" {{ $service->delivery_time == '4' ? 'selected' : '' }}>4
                                                    Hari</option>
                                                <option value="6" {{ $service->delivery_time == '6' ? 'selected' : '' }}>
                                                    6 Hari</option>
                                                <option value="8" {{ $service->delivery_time == '8' ? 'selected' : '' }}>
                                                    8 Hari</option>
                                                <option value="10"
                                                    {{ $service->delivery_time == '10' ? 'selected' : '' }}>10 Hari
                                                </option>
                                            </select>
                                        </div>

                                        {{-- input form revision_limit --}}
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="revision_limit" name="revision_limit" autocomplete="revision_limit"
                                                ...
                                                <option value="2"
                                                    {{ $service->revision_limit == '2' ? 'selected' : '' }}>
                                                    2
                                                    Kali</option>
                                                <option value="4"
                                                    {{ $service->revision_limit == '4' ? 'selected' : '' }}>
                                                    4
                                                    Kali</option>
                                                <option value="6"
                                                    {{ $service->revision_limit == '6' ? 'selected' : '' }}>
                                                    6 Kali</option>
                                                <option value="8"
                                                    {{ $service->revision_limit == '8' ? 'selected' : '' }}>
                                                    8 Kali</option>
                                                <option value="10"
                                                    {{ $service->delivery_time == '10' ? 'selected' : '' }}>10 Hari
                                                </option>
                                                ...
                                                @forelse ($thumbnail_service as $thumbnail_item)
                                                    <div class="mb-2">
                                                        <img src="{{ url(Storage::url($thumbnail_item->thumbnail)) }}"
                                                            alt="thumbnail" for="choose"
                                                            class="inlie object-cover w-20 h-20 rounded">
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    <a href="{{ route('member.service.index') }}" type="button"
                                        ...
                                        onclick="return confirm('Are you sure want to cancel? , Any changes you make will note be saved.')">
                                        Cancel
                                    </a>
