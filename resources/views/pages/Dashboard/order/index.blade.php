                            ...
                            <tbody class="bg-white">
                                ...
                                @forelse ($orders as $item)
                                    <tr class="text-gray-700 border-b">
                                        {{-- photo name and role frelancer --}}
                                        <td class="px-1 py-5 text-sm w-2/8">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">

                                                    {{-- cek apakah photo ada pada storage --}}
                                                    ...
                                                    @else
                                                        {{-- jika tidak ada akan menampilkan svg --}}
                                                ...
                                                <div>
                                                    ...
                                                    {{-- menampilkan nama buyer --}}
                                                    <p class="font-medium text-black">
                                                        {{ $item->user_buyer->name ?? '' }}</p>
                                                    <p class="text-sm text-gray-400">
                                                        {{ $item->user_buyer->detail_user->role ?? '' }}</p>
                                                </div>
                                            </div>
                                        </td>

                                        {{-- thumbnail and title service --}}
                                        ...
                                        <td class="px-1 py-5 text-xs text-red-500">
                                            ...
                                            {{ (strtotime($item->expired) - strtotime(date('Y-m-d'))) / 86400 ?? '' }}
                                            days
                                            left
                                        </td>
